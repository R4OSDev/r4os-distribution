...
$required = @(
    ...
    '[INSTALLBOOT] mapping=verified C=SYSTEM D=DATA BOOT=unlettered',
    ...
    'LOADERD result: OK',
    'APPHEAPD allocator churn: OK small=64 direct=32',
    'APPHEAPD result: OK churn=bounded cleanup=trimmed',
    'RESDIAG result: OK',
