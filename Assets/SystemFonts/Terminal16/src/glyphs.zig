// Builder-local Terminal16 glyph data.
//
// This file intentionally does not import the Kernel-Font module. TERMINAL16.R4F is
// a systemfont artifact built by a host tool, not a kernel-font derivative.
...
pub fn westernGlyph(codepoint: u32) [8]u8 {
