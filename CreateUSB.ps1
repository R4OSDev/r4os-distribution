...
try {
 ...
 if($selected.sectorBytes -ne 512 -or $selected.bytes%512 -ne 0 -or $selected.bytes -lt (31723520L+32769+33)*512){throw 'USB-Geometrie ungeeignet: 512-Byte-Sektoren und mindestens 15507 MB erforderlich (32-GB-Stick empfohlen).'}
